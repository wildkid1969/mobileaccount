...
public class UmengHttpClient {
    ...
    public static String sentRequest(String fullUrl, HttpMethod httpMethod, Map<String, Object> data) {
        if(fullUrl==null){
            return null;
        }
        String result = null;
        ...
        if (httpMethod == HttpMethod.GET || httpMethod == HttpMethod.DELETE) {
            fullUrl = fullUrl + buildParameter(ACCESS_TOKEN, WsqMain.APP_KEY, data);
            System.out.println("Umeng rest url:" + fullUrl);
        } else {
            fullUrl = fullUrl + buildParameter(ACCESS_TOKEN, WsqMain.APP_KEY, null);
            System.out.println("Umeng rest url:" + fullUrl);
        }
     ...
     * @return
     */
    private static String buildParameter(String accessToken, String appKey, Map<String, Object> data) {
        StringBuilder sb = new StringBuilder();
        if (appKey != null && !appKey.equals("")) {
            sb.append("?ak=" + WsqMain.APP_KEY);
        } else {
...
//        }
    ...
    private static void setRequestMethod(HttpMethod httpMethod, HttpURLConnection urlConnection) throws ProtocolException {
        switch (httpMethod) {
            case POST:
     ...
     */
    public static String accessTokenRequest(Map<String, Object> data, String url, String APP_SECRET) {
        String stringData = "";
        try {
     ...
     * @return
     */
    public static String uploadImage(String accessToken, String pathOfImage, Map<String, Object> map) {
        HttpURLConnection urlConnection;
        OutputStream outputStream;
        try {
    ...
    private static void addBinaryParams(String name, OutputStream outputStream, byte[] data) throws IOException {
	...
	private static void addBodyParams(OutputStream outputStream, Map<String, Object> bodyMaps)
            throws IOException {
    ...
    private static boolean isListParams(Object param) {
    ...
    private static void addListParams(StringBuilder stringBuilder, String key, List<String> param) {
