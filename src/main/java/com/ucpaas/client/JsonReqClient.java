...
import com.ucpaas.models.AppBill;
import com.ucpaas.models.Callback;
import com.ucpaas.models.ClientBill;
import com.ucpaas.models.TemplateSMS;
import com.ucpaas.models.VoiceCode;
import com.ucpaas.utils.DateUtil;
import com.ucpaas.utils.EncryptUtil;
public class JsonReqClient extends AbsRestClient {
	...
	public String charegeClient(String accountSid, String authToken,
		...
		try {
			...
			client.setCharge(df.format(Double.parseDouble(charge)));
			client.setAppId(appId);
			Gson gson = new Gson();
			String body = gson.toJson(client);
			body="{\"client\":"+body+"}";
